...
assert.ok(hazard.includes('KsjTmplt-A31.html'), 'hazard UI must attribute flood data A31')
assert.ok(hazard.includes('KsjTmplt-A40.html'), 'hazard UI must attribute tsunami data A40')
assert.ok(hazard.includes('KsjTmplt-A33-2018.html'), 'hazard UI must attribute landslide data A33-2018')
